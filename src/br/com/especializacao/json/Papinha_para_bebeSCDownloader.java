...
public class Papinha_para_bebeSCDownloader extends AsyncTask<Void,Void,ArrayList<Subcategory>>{

	private ListaItemSCActivity uiLista;
	private ProgressDialog dialog;
	public Papinha_para_bebeSCDownloader(ListaItemSCActivity listaActivity){
