...
public class Sobremesas_confeitariaDownloader extends AsyncTask<Void,Void,ArrayList<Subcategory>>{

	private ListaItemActivity uiLista;
	private ProgressDialog dialog;
	public Sobremesas_confeitariaDownloader(ListaItemActivity listaActivity){
