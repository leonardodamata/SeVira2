...
public class Bebida_nao_alcoolicaSCDownloader extends AsyncTask<Void,Void,ArrayList<Subcategory>>{

	private ListaItemSCActivity uiLista;
	private ProgressDialog dialog;
	public Bebida_nao_alcoolicaSCDownloader(ListaItemSCActivity listaActivity){
