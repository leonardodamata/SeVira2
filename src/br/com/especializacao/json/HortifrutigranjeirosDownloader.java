...
public class HortifrutigranjeirosDownloader extends AsyncTask<Void,Void,ArrayList<Subcategory>>{

	private ListaItemActivity uiLista;
	private ProgressDialog dialog;
	public HortifrutigranjeirosDownloader(ListaItemActivity listaActivity){
