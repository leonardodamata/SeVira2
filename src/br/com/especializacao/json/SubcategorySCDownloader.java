...
import br.com.especializacao.sevira2.ListaSCActivity;
 
import android.app.ProgressDialog;
import android.os.AsyncTask;
import android.util.Log;

public class SubcategorySCDownloader extends AsyncTask<Void,Void,ArrayList<Subcategory>>{

	private ListaSCActivity uiLista;
	private ProgressDialog dialog;
	
		
	public SubcategorySCDownloader(ListaSCActivity listaActivity){
