...
public class LaticiniosSCDownloader extends AsyncTask<Void,Void,ArrayList<Subcategory>>{

	private ListaItemSCActivity uiLista;
	private ProgressDialog dialog;
	public LaticiniosSCDownloader(ListaItemSCActivity listaActivity){
	...
	protected void onPreExecute(){
		super.onPreExecute();
		dialog = ProgressDialog.show(uiLista,"Aguarde","Carregando Laticínios");
	}
	@Override
	protected ArrayList<Subcategory> doInBackground(Void... params){
		JSONParser parser = new JSONParser();
		JSONObject json = parser.getJSONFromUrl("https://dl.dropbox.com/s/t0bd845vir7xzci/laticinios.json");
