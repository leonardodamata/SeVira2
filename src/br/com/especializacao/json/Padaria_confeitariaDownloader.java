...
public class Padaria_confeitariaDownloader extends AsyncTask<Void,Void,ArrayList<Subcategory>>{

	private ListaItemActivity uiLista;
	private ProgressDialog dialog;
	public Padaria_confeitariaDownloader(ListaItemActivity listaActivity){
