...
public class Bebida_alcoolicaDownloader extends AsyncTask<Void,Void,ArrayList<Subcategory>>{

	private ListaItemActivity uiLista;
	private ProgressDialog dialog;
	public Bebida_alcoolicaDownloader(ListaItemActivity listaActivity){
