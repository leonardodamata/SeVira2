...
public class AgendarListaActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(qdte==0){
			...
			Intent i = new Intent(AgendarListaActivity.this, Main2Activity.class);
			startActivity(i); 
	...
	protected void onListItemClick(ListView  l, View v, int position, long id){
		...
		Toast.makeText(getApplicationContext(), "Agendar Data!",Toast.LENGTH_SHORT).show();
		Intent i = new Intent(getApplicationContext(), AgendarDataActivity.class);
		i.putExtra("id_lista",compra.getId());
		startActivity(i);
